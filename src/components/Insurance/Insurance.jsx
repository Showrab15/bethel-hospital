...
const Insurance = () => {
  ...
  return (
    <div className="px-4 md:px-8 lg:px-16 mt-10">
       <div className="bg-[#CDB0D0] w-full px-4 md:px-6 py-10 md:py-[81px] ">
  ...
  TAMIL NADU GOVERNMENT NEW HEALTH INSURANCE SCHEME <br /> FOR PENSIONERS
        ...
        <div className="flex flex-col lg:flex-row gap-6 mt-10 justify-center items-center">
          ...
          <h6 className="text-[#121212] font-bold text-base md:text-lg text-center lg:text-left min-w-[200px]">
            {selectedCompany ? selectedCompany.name : "INSURANCE COMPANY"}
          </h6>
          ...
          <div className="flex w-full max-w-md bg-white rounded-lg shadow-md overflow-hidden">
            <input
              ...
              onChange={handleSearch}
              placeholder="Type insurance company name..."
              className="flex-grow p-3 pl-4 text-gray-800 bg-white border-none focus:outline-none"
            />
            <button className="bg-purple-600 text-white px-5 py-2 text-sm md:text-base hover:bg-purple-700 focus:outline-none">
              Search
            </button>
          </div>
