        ...
        <ul className="ml-20 hidden md:flex items-center space-x-9 text-lg text-[#000000AB] font-regular">
          <li>
            <NavLink
              ...
              aria-label="Home"
              className={({ isActive }) =>
                isActive ? "text-[#8F3E97] border-b-2 border-[#8F3E97] hover:text-[#000000AB]" : "hover:text-[#8F3E97]"
              }            >
              Home
            </NavLink>
          </li>
          <li>
            <NavLink
              ...
              aria-label="Services"
              className={({ isActive }) =>
                isActive ? "text-[#8F3E97] hover:text-[#000000AB] border-b-2 border-[#8F3E97]" : "hover:text-[#8F3E97]"
              }
            >            
              Services
            </NavLink>
