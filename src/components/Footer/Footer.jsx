      ...
      <div className="bg-[#8F3E97] px-6 md:px-10 lg:px-[60px] py-10 md:py-16 lg:py-[80px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-4 gap-4">
          <p className="text-[#FCFEFE] text-center md:text-left text-sm md:flex gap-2 ">
            © Copyright {new Date().getFullYear()} Bethel Hospital - All Rights Reserved  <br className="" />
            <a  href="https://www.linkedin.com/company/creative-lance" target="_blank" rel="noopener noreferrer">Powered By Creative Lance
