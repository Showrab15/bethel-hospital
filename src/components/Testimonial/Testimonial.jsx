...
//             <div
//               key={index}
//               className="grid grid-cols-3 min-w-full gap-8 px-8 py-10 bg-[#8F3E9742]"
//             >
//               {group.map((testimonial) => (
//                 <div
//                   key={testimonial.id}
//                   className="relative text-center max-w-xl max-h-min p-2 bg-[#F8F0FF] border border-[#8F3E97] rounded-lg"
//                 >
